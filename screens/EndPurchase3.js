...
export default function EndPurchase3({navigation}) {
  ...
  const [img3, setImg3] = useState(require("../assets/images/mercadoPago1.png"))
    ...
    return (
      <SafeAreaView style={{flex: 1}}>
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity style={[styles.button2, {marginRight:"2%", backgroundColor:backColor2}]} activeOpacity={0.7} onPress={() => press2()}>
            <Image style={styles.image} source={img2} />
            <Text style={[styles.text3, {color:txt2}]}>Tarjetas bancarias</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.button2, {marginLeft:"2%", backgroundColor:backColor3}]} activeOpacity={0.7} onPress={() => press3()}>
        ...
        <View
          ...
          <TouchableOpacity style={styles.button3} activeOpacity={0.7} onPress={() => navigation.navigate("EndPurchase4")}>
